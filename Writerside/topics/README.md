...
> 
_For more examples, please refer to the venom [Documentation](Architecture.md)_
...
Contributions are what make the open source community such an amazing place to learn, inspire, and create. Any contributions you make are **greatly appreciated**. If you want to learn more about the architecture of the project, please refer to the venom [Documentation](Architecture.md).
